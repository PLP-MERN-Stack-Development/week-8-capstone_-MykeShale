...
export default function AppointmentsPage() {
  ...
  const appointments = [
    ...
    },
    {
      ...
      notes: "Discuss skin condition and treatment options",
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 4.9,
      duration: "30 min",
      price: "Free",
    ...
    },
    {
      ...
      notes: "X-ray examination completed, prescribed physical therapy",
      avatar: "/placeholder.svg?height=40&width=40",
      rating: 4.7,
      duration: "60 min",
      price: "Free",
            ...
            {upcomingAppointments.length === 0 && (
              <Card className="border-0 shadow-sm">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-600 mb-4">Book your next appointment to stay on top of your health</p>
                  <Button className="bg-emerald-600 hover:bg-emerald-700">
                    <Plus className="h-4 w-4 mr-2" />
                    Book Appointment
                  </Button>
