...
export default function DoctorPatientsPage() {
  ...
  const patients = [
    ...
    },
    {
      ...
      appointments: 18,
      nextAppointment: "Feb 1, 11:00 AM",
      lastMessage: "My cholesterol levels are stable.",
    },
  ]
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600">Manage and view details of your assigned patients</p>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col items-end space-y-3">
                      ...
                      <div className="text-right text-sm">
                        <p className="font-semibold text-gray-900">{patient.appointments} appointments</p>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                  ...
                                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div className="text-sm text-gray-600">
                                      Last Message: {selectedPatient.lastMessage}
                                    </div>
                                  </div>
                                </div>
